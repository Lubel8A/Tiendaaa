function getBotResponse(input) {
    ...
    if (input.toLowerCase().includes(key10.toLowerCase())) {
        return "Hola, bienvenido al Mundo Azucarado. Estoy aquí para resolver tus dudas, puedes preguntarme algo.";
    } else if (input.toLowerCase().includes(key9.toLowerCase())) {
        return "Nos vemos luego y gracias por visitar El Mundo Azucarado!";
    } else if (input.toLowerCase().includes(key.toLowerCase()) ) {
        return "Si deseas mayor información, contáctanos al correo elmundoazucarado@hotmail.com o al siguiente teléfono +51 987465321";
